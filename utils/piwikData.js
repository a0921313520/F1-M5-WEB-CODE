...
export function SetPiwikData(gameCatCode, providerCode, actionType) {
    console.log(
        "🚀 ~ file: piwikData.js:8 ~ SetPiwikData ~ gameCatCode:",
        gameCatCode,
    );
    ...
    if (gameCatCode === "Esports") {
        switch (providerCode) {
            case "IPES":
                Pushgtagdata(
                    "ESports_TopNav​",
                    "Launch Fun88 Esports​",
                    "ESports_TopNav_C_Fun88",
                );
                break;
            case "TFG":
                Pushgtagdata(
    ...
    if (gameCatCode === "LiveCasino") {
        switch (providerCode) {
            case "EVO":
                Pushgtagdata(
                    "LiveDealer_TopNav​",
                    "Go to EVO Palace Lobby​",
                    "LiveDealer_TopNav_C_EVO_Palace",
                );
                break;
            case "GPI":
                Pushgtagdata(
                    "LiveDealer_TopNav​",
                    "Go to Fun88 Palace Lobby​",
                    "LiveDealer_TopNav_C_Fun88_Palace​",
                );
                break;
            case "AGL":
                Pushgtagdata(
                    "LiveDealer_TopNav​",
                    "Go to ROYAL Palace​ Lobby​​",
                    "LiveDealer_TopNav_C_ROYAL_Palace​​",
                );
                break;
            case "NLE":
                Pushgtagdata(
                    "LiveDealer_TopNav​",
                    "Go to HAPPY Palace​ Lobby​​",
                    "LiveDealer_TopNav​​_C_HAPPY_Palace​​​",
                );
                break;
            // case "SXY":
            ...
            case "EBT":
                Pushgtagdata(
                    "LiveDealer_TopNav​",
                    "Go to E Palace Lobby​",
                    "LiveDealer_TopNav_C__E_Palace​​​",
                );
                break;
            case "WEC":
                Pushgtagdata(
                    "LiveDealer_TopNav​",
                    "Go to WE Palace Lobby​",
                    "LiveDealer_TopNav_C_WE​",
                );
                break;
            case "WMC":
                Pushgtagdata(
                    "LiveDealer_TopNav​",
                    "Go to WM Palace​ Lobby​​",
                    "LiveDealer_TopNav​​_C_WM_Palace​​​",
                );
                break;
            case "PP":
                Pushgtagdata(
                    "LiveDealer_TopNav​",
                    "Go to PP Palace​ Lobby​​",
                    "LiveDealer_TopNav_C_PP_Palace​​​​",
                );
                break;
            case "AEC​​":
                Pushgtagdata(
                    "LiveDealer_TopNav​",
                    "Go to S Palace​ Lobby​​​",
                    "LiveDealer_TopNav​​_C_S_Palace​​​",
                );
                break;
            default:
                break;
...
export function staticHeaderGtag(
    ...
    console.log(
        "🚀 ~ file: piwikData.js:356 ~ gameCatCode:",
        gameCatCode,
        providerCode,
    );
    sessionStorage.setItem("isGamePage", true);
    ...
    switch (code) {
        case "Sportsbook":
            Pushgtagdata(
                ...
                "Home_TopNav_C_Sports",
            );
            break;
        case "ESports":
            Pushgtagdata(
                "Home_TopNav",
                "Go to Esports Listing",
                "Home_TopNav_C_Esports",
            );
            break;
        case "InstantGames":
            Pushgtagdata(
                "Home_TopNav",
                "Go to Instant Game Listing",
                "Home_TopNav_C_InstantGames",
            );
            break;
        case "LiveCasino":
            Pushgtagdata(
                "Home_TopNav",
                "Go to LD Listing",
                "Home_TopNav_C_LiveDealer",
            );
            break;
        case "Slot":
            Pushgtagdata(
                "Home_TopNav",
                "Go to Slot/Fishing Listing",
                "Home_TopNav_C_SlotFishing",
            );
            break;
        case "P2P":
            Pushgtagdata(
        ...
        case "KenoLottery":
            Pushgtagdata(
                "Home_TopNav",
                "Go to Lottery Listing",
                "Home_TopNav_C_Lottery",
            );
            break;
        case "promotions":
            Pushgtagdata(
    ...
    switch (code) {
        ...
        case "ESports":
            Pushgtagdata(
                "Esports_TopNav",
                "Go to Esports Listing",
                "Esports_TopNav_C_Listing",
            );
            break;
        case "InstantGames":
            Pushgtagdata(
                "InstantGames_TopNav",
                "Go to InstantGames Listing",
                "InstantGames_TopNav_C_Listing",
            );
            break;
        case "LiveCasino":
            Pushgtagdata(
                "LiveDealer_TopNav",
                "Go to LiveDealer Listing",
                "LiveDealer_TopNav_C_Listing​",
            );
            break;
        case "Slot":
            Pushgtagdata(
...
export const gameLobbyFilterTypeDataPiwik = (providerCode, gameType) => {
    console.log(
        "🚀 ~ file: piwikData.js:779 ~ gameLobbyFilterTypeDataPiwik ~ providerCode:",
        providerCode,
        ",",
        gameType,
    );
...
export const gameLobbyOpenGamePiwik = (gameCatCode, providerCode) => {
    console.log(
        "🚀 ~ file: piwikData.js:805 ~ gameLobbyOpenGamePiwik ~ gameCatCode, providerCode:",
        gameCatCode,
        providerCode,
    );
    ...
    switch (gameCatCode) {
        case "Sportsbook":
            Pushgtagdata(
                "SportsListing​",
                `Launch ${providerCode} Game​`,
                `SportsListing_C_Enter_${providerCode}_Game​`,
            );
            break;
        case "ESports":
            Pushgtagdata(
                "ESports_Listing​",
                `Launch ${providerCode} Game​`,
                `ESports_Listing_C_Enter_${providerCode}_Game​`,
            );
            break;
        default:
            break;
...
export const gameListOpenGamePiwik = (item) => {
    console.log(
        "🚀 ~ file: piwikData.js:826 ~ gameListOpenGamePiwik ~ item:",
        item,
    );
...
export const gameLobbyPageTrackingPiwik = (item) => {
    console.log(
        "🚀 ~ file: piwikData.js:866 ~ gameLobbyPageTrackingPiwik ~ item:",
        item,
    );
    switch (item) {
        case "LiveCasino":
