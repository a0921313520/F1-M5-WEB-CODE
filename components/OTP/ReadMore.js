            ...
            <Row>
                <Col span={24}>
                    ...
                    <div className="otp-modal-description">
                        ...
                        <div>
                            {translate(
                                "Fun88始终以最优质的服务标准为目标。 为了打造一个有信誉、安全的游乐场所，Fun88不断完善会员的信息安全体系。 因此，Fun88鼓励会员验证电子邮箱和电话号码，以增强账户安全。 会员登录后，Fun88将通过电子邮件或短信发送确认码。",
                            )}
                        </div>
                        <br />
                        <p style={{ margin: 0 }}>
                        ...
                        <p>
                            {translate(
                                "Fun88 一直在不断改进，以提供流畅、安全的游戏体验。 衷心感谢会员们长期以来的配合与陪伴。",
                            )}
                        </p>
