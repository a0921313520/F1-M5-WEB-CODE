...
import { Row, Col, Modal, message, Radio, Input, Button,Icon,Spin } from "antd";
...
class PromotionsAddress extends Component {
    ...
    ApplyDailyDeals = () => {
        ...
        post(
            ApiPort.PostDailyDeals + `&bonusRuleId=${data.bonusRuleId}`,
            data
        ).then((res) => {
            if (res) {
                if (res.isSuccess) {
            ...
            <>
                ...
                >
                    ...
                    <Row>
                                            ...
                                            >
                                                ...
                                                >
                                                    <div className="mid-info-nameAndPhone">
                                                        <span className="name">
                                                            {getMaskHandler("Security answer",lastName)}
                                                            {" "}
                                                            {getMaskHandler("Security answer",firstName)}
                                                        </span>
                                                        <span>
                                                            {getMaskHandler("Phone",cellphoneNo)}
                                                        </span>
                                                    </div>
                                                    <div className="mid-info-address">
                                                        {provinceName +districtName + townName + address}
                                                    </div>
                                                </div>
                                                <span
                                                    className="editBox"
                        ...
                        {/* ------------------- 新增运送地址 ------------------- */}
                        {Array.isArray(Address) && Address.length < 3 ? <Col>
                            <div className="DailyGiftAddress-btn">
                                ...
                                >
                                    <Icon type="plus-circle" style={{color:"#00a6ff"}}/>
                                    {translate("添加地址")}
                                </Button>
                            </div>
                        </Col> : null}
