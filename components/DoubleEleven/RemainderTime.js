...
export default class Main extends React.PureComponent {
    constructor(props) {
        ...
        this.state = {
            activeStatusString: "　",
            startDate: "2021/11/10 00:00:00",
            endDate: "2021/11/14 23:59:59",
        };
        ...
        this.startTimeConfig = "2021/11/10 00:00:00";
        this.endTimeConfig = "2021/11/14 23:59:59";
        this.readyStringConfig = "活 动 即 将 开 始";
        this.startStringConfig = "活 动 热 映 中";
        this.endStringConfig = "活 动 已 截 止";
        this.endTimeInterval = null;

        // 模拟测试
        // this.startTimeConfig = "2021/08/17 22:23:00";
        // this.endTimeConfig = "2021/08/18 22:23:30";
    }
    componentDidMount() {
        get(ApiPort.LuckySpinDouble)
            .then((res) => {
        ...
        return (
            <div className="ramain-time-wrapper">
                <div className="ramain-time-title">
                    ...
                    this.startStringConfig ? (
                        <img src="/vn/img/doubleEleven2021/startStringConfig.png" />
                    ) : this.state.activeStatusString ===
                      this.readyStringConfig ? (
                        <img src="/vn/img/doubleEleven2021/readyStringConfig.png" />
                    ) : this.state.activeStatusString ===
                      this.endStringConfig ? (
                        <img src="/vn/img/doubleEleven2021/endStringConfig.png" />
                    ) : (
                        <div style={{ width: 173, height: 53 }}></div>
                    )}
                </div>
